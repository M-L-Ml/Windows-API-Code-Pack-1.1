...
{
    using tdk = TaskDialogCommonButtonsCopy;
    //--------------------------------------------------------------------------------
    #region PUBLIC enums
    //--------------------------------------------------------------------------------
    ...
    /// <summary>
    /// <see cref="Microsoft.WindowsAPICodePack.Dialogs.TaskDialogNativeMethods.TaskDialogCommonButtons"/>
    /// </summary>
    [Flags]
    internal enum TaskDialogCommonButtonsCopy
    {
    ...
    {
        YesNo = tdk.Yes | tdk.No, YesNoCancel = YesNo | tdk.Cancel, OKCancel = tdk.Ok | tdk.Cancel,
        OK = tdk.Ok, Close = tdk.Close, Cancel = tdk.Cancel, None = 0
    }
    #endregion
